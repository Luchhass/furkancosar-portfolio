...
export const metadata = createPageMetadata({
  ...
  description:
    "Learn about Furkan Cosar, also written Furkan Coşar, a frontend developer focused on clean UI, responsive websites, React, Next.js, GSAP and real project experience.",
  path: "/about",
  keywords: [
    "about Furkan Cosar",
    "about Furkan Coşar",
